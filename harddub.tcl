...
## ---------------------------------------------------------------------------
## 	  harddub - sequental backup utility for use with NTFS hardlinks
##    Copyright by Nikolay Ragozin
##
...
###############MSGCAT copy to use freewrap (dont remember what problem it was that i inlined this)##############
